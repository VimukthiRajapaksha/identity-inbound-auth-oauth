...
public interface AuthorizationDetailProcessor {
    ...
    // ValidationResult isEqualOrSubset(AuthorizationDetailContext authorizationDetailContext);

    // void enrich(AuthorizationDetailContext authorizationDetailContext);
}
